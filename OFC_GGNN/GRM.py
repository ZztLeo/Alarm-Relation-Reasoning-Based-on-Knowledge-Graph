...
class GRM(nn.Module):
    def __init__(self, adjacency_matrix, num_class = 4, ggnn_hidden_channel = 16, ggnn_output_channel = 6,
                 time_step = 3, alarm_num = 10):
    ...
    def forward(self, alarm, alarm_anno, root_cause_alarm):
